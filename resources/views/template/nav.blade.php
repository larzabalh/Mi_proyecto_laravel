<div id="wrapper">
  <!-- Esto es el primer header, la barra gris -->
  <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">ESTUDIO LARZABAL V 2.0</a>
      </div>
      <!-- /.navbar-header -->
      ...
      <ul class="nav navbar-top-links navbar-right">
          <li class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-messages">
                <!-- NOTE: Esto son los desplegables de arriba a la derecha -->
                  <li>
                      <a href="#">
                          <div>
                            <!-- NOTE: Estos son los desplegables propiamentedicho -->
                              <strong>Leer</strong>
              ...
              <!-- /.Aca termina el dropdown de los mensajes -->
          </li>
          <!-- / Comienza el segundo dropdown-->
          <li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#">
              ...
              <ul class="dropdown-menu dropdown-tasks">
                  <li>
                      <a href="#">
                          <div>
                              <p>
                                <!-- NOTE: desplegables propiamente dichos -->
              ...
              <!-- Aca termina el segundo dropdown-->
          </li>
          <!-- / Tercer dropdown -->
          <li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#">
              ...
              <ul class="dropdown-menu dropdown-alerts">
                  <li>
                      <a href="#">
                          <div>
                            <!-- NOTE: desplegable propiamente dicho -->
              ...
              <!-- / Aca termina el tercer dropdown-->
          </li>
          <!-- /.Cuarto dropdown -->
          <li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#">
              ...
              <!-- /.ACa termina el cuarto dropdown-user -->
          </li>
          <!-- /.dropdown -->
      </ul>
      <!-- /.navbar-top-links -->
                ...
                <!-- NOTE: barra de navegacion -->
                  ...
                  <li>
                      ...
                      <ul class="nav nav-second-level">
                          ...
                          <li>
                              <a href="typography.php">HERRAMIENTA 4</a>
                          </li>
                          <li>
                              <a href="icons.php"> HERRAMIENTA 5</a>
                          </li>
                          <li>
                              <a href="grid.php">HERRAMIENTA 6</a>
                          </li>
                      </ul>
                      <!-- /.nav-second-level -->
                  </li>
      ...
      <!-- NOTE: ACA TERMINA EL MENU DE LA IZQUIERDA -->
